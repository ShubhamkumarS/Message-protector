...
#icon
image_icon=PhotoImage(file="Image3/icon.png")
root.iconphoto (False,image_icon)

#main
Top_image=PhotoImage(file="Image3/top image.png")
...
Button_icon=PhotoImage(file="Image3/button image.png")
...
button_icon=PhotoImage(file="Image3/button.png")
